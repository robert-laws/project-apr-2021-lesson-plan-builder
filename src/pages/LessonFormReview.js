...
const LessonFormReview = ({ handleReverseStep }) => {
  ...
  const { newLesson } = lessonsContext;
  ...
  return (
    <div>
      ...
      <div className='container mx-auto px-4'>
        ...
        <div className='mt-8 grid grid-cols-5 gap-6 items-start'>
          <div className='grid grid-cols-1 gap-6'>
            <h3 className='text-base font-bold text-right'>Lesson Duration</h3>
          </div>
          <div className='grid grid-cols-1 col-span-4 gap-6'>
        ...
        <div className='mt-8 grid grid-cols-5 gap-6 items-start'>
          ...
          <div className='grid grid-cols-1 col-span-4 gap-6'>
            <div
              dangerouslySetInnerHTML={{ __html: newLesson.learning_outcomes }}
            />
          </div>
        </div>
        <div className='mt-8 grid grid-cols-5 gap-6 items-start'>
        ...
        <div className='mt-8 grid grid-cols-5 gap-6 items-start'>
          <div className='grid grid-cols-1 gap-6'>
            <h3 className='text-base font-bold text-right'>Modules Details</h3>
          </div>
          <div className='grid grid-cols-1 col-span-4 gap-6'>
            <div
